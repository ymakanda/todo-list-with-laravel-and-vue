<template>
    <div>
        ...
        <div class="w-1/2 bg-white rounded shadow-2xl p-8 m-4">
            <h1 class="block w-full text-center text-gray-800 text-2xl font-bold mb-6">Create Todo</h1>
...
<script>
    export default{
        ...
        methods:{
            addItem(){
                this.axios.post('/api/items', this.item).then(response =>(this.$router.push({name: 'items'})))
